                ...
                while ($row = $resultado->fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href='delete.php?id={$row['id']}&redirect=index.php' class='btn btn-sm btn-danger btn-action' onclick='return confirm(\"Tem certeza que deseja excluir este usuário?\")'> Excluir</a>
                        </td>
                    </tr>
                    ";
                }

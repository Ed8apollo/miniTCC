...
if($resultado->num_rows > 0){
    while ($row = $resultado->fetch_assoc()){
        ...
        echo "<tr>
            ...
            <td>
                <a href='edituser.php?id={$row['id']}' class='btn btn-sm btn-warning btn-action'> Editar</a>
                <a href='#' class='btn btn-sm btn-danger delete-category' 
       data-id='{$row['id']}' 
       data-name='{$row['nome']}'>Excluir</a>
                <a href='deleteuser.php?id={$row['id']}&redirect=gerenciarmusers.php' class='btn btn-sm btn-danger btn-action' onclick='return confirm(\"Tem certeza que deseja excluir este usuário?\")'> Excluir</a>
            </td>
        </tr>";
    }
} else {

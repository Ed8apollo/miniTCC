            ...
            <div class="col-md-8">
                <div class="menu-section">
                    ...
                    <div class="text-center mb-4">
                        <a href="createuser.php" class="menu-btn btn-lg">
            ...
            if($resultado->num_rows > 0){
                while ($row = $resultado->fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <a href='deleteuserprod.php?id={$row['id']}&redirect=listapro_usuario.php' class='btn btn-sm btn-danger btn-action' onclick='return confirm(\"Tem certeza que deseja excluir este usuário?\")'> Excluir</a>
                        </td>
                    </tr>
                    ";
                }
